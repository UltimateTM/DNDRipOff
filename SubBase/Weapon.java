...
public class Weapon extends Item{
	...
	public void equip(Character me){
  	...
  	protected Weapon() {
    	shopWeaponItems.add(new Weapon(3.0, 5, "Rondeau's Rage"));
    	shopWeaponItems.add(new Weapon(5.0, 8, "Garfield's Lasag"));
    	shopWeaponItems.add(new Weapon(7.0, 9, "Sanchez's Demise"));
    	shopWeaponItems.add(new Weapon(1.0, 1, "DeMaso's Dagger"));
